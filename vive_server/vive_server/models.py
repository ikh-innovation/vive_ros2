...
class ViveDynamicControllerMessage(BaseModel):
    valid: int = Field(default=0)
    x: float = Field(default=0)
    y: float = Field(default=0)
    z: float = Field(default=0)
    ...
    q: float = Field(default=0)
    r: float = Field(default=0)
    menu_butt: bool = Field(default=0)
    trig: float = Field(default=0)
    pad_x: float = Field(default=0)
    pad_y: float = Field(default=0)
    pad_touch: int = Field(default=0)
    pad_butt: int = Field(default=0)
    ul_butt: int = Field(default=0)
    ul_touch: int = Field(default=0)
    grip_butt: int = Field(default=0)
    device_name: str = Field(default="None")
    serial_num: str = Field(default="None")
